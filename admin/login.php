...
<body>
    ...
    <div class="Main">
        <ul>
            ...
            <li class="top2"></li>
            <li class="topA"></li>
            <li class="topB"><span><img src="../public/admin/images/login/6.gif" alt="图像" style="" /></span></li>
            <li class="topC"></li>
            <li class="topD">
                <ul class="login">
					...
					<li><span class="left login-text">验证码：</span> <span style="left">
                       <input id="Text3" type="text" class="txt" name="code" style="width:100px"/><img src="../public/code.php" style="width:80px;margin-left:10px">
                    </span></li>
            ...
            <li class="middle_C"><span class="btn"><input name="" type="image" src="../public/admin/images/login/btnlogin.gif" /></span></li>
