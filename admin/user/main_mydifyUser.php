...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="" target="mainFrame" onFocus="this.blur()" class="add">修改用户</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="doModifyUser.php">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">用户名：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="userName" value="<?php echo $_GET['userName'] ?>" class="text-word" disabled='disabled' />
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <option value="0" <?php echo $_GET['auth'] == '0' ? 'selected="selected"' : '' ;  ?> >&nbsp;&nbsp;普通用户</option>
	    <option value="1" <?php echo $_GET['auth'] == '1' ? 'selected="selected"' : '' ;  ?> >&nbsp;&nbsp;管理员</option>
        </select>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input name="" type="submit" value="确认修改" class="text-but">
